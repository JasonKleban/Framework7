...
// Remove Diacritics
var defaultDiacriticsRemovalap$1 = [
    { base: 'A', letters: '\u0041\u24B6\uFF21\u00C0\u00C1\u00C2\u1EA6\u1EA4\u1EAA\u1EA8\u00C3\u0100\u0102\u1EB0\u1EAE\u1EB4\u1EB2\u0226\u01E0\u00C4\u01DE\u1EA2\u00C5\u01FA\u01CD\u0200\u0202\u1EA0\u1EAC\u1EB6\u1E00\u0104\u023A\u2C6F' },
    { base: 'AA', letters: '\uA732' },
    { base: 'AE', letters: '\u00C6\u01FC\u01E2' },
    { base: 'AO', letters: '\uA734' },
...
var diacriticsMap$1 = {};
for (var i = 0; i < defaultDiacriticsRemovalap$1.length; i += 1) {
    var letters = defaultDiacriticsRemovalap$1[i].letters;
...
var Utils$1 = {
    ...
    bezier: function () {
        ...
        return bezier.apply(void 0, __spread(args));
    },
    ...
    promise: function (handler) {
        ...
        var promise = {
            then: function (thenHandler) {
                if (resolved) {
                    thenHandler.apply(void 0, __spread(resolveArgs));
                }
                else {
                ...
                if (rejected) {
                    catchHandler.apply(void 0, __spread(rejectArgs));
                }
                else {
        ...
        function resolve() {
            ...
            resolved = true;
            if (promiseHandlers.then)
                promiseHandlers.then.apply(promiseHandlers, __spread(args));
            else
                resolveArgs = args;
        }
        function reject() {
            ...
            rejected = true;
            if (promiseHandlers.catch)
                promiseHandlers.catch.apply(promiseHandlers, __spread(args));
            else
                rejectArgs = args;
        }
    ...
    removeDiacritics: function (str) {
        return str.replace(/[^\u0000-\u007E]/g, function (a) { return diacriticsMap$1[a] || a; });
    },
...
var Framework7Class = (function () {
    ...
    Framework7Class.prototype.on = function (events, handler) {
        var self = this;
    ...
    Framework7Class.prototype.once = function (events, handler) {
        var self = this;
    ...
    Framework7Class.prototype.off = function (events, handler) {
        var self = this;
        events.split(' ').forEach(function (event) {
    ...
    Framework7Class.prototype.emit = function () {
        ...
        if (eventsParents && eventsParents.length > 0) {
            eventsParents.forEach(function (eventsParent) {
                eventsParent.emit.apply(eventsParent, __spread([events], data));
            });
        }
        return self;
    };
    Framework7Class.prototype.useInstanceModulesParams = function (instanceParams) {
        var instance = this;
        if (!instance.modules)
            return;
    ...
    Framework7Class.prototype.useInstanceModules = function (modulesParams) {
    ...
    Framework7Class.installModule = function (module) {
        var params = [];
    ...
    Framework7Class.use = function (module) {
        var params = [];
        for (var _i = 1; _i < arguments.length; _i++) {
            params[_i - 1] = arguments[_i];
        }
...
var Framework7$1 = (function (_super) {
    __extends(Framework7, _super);
    ...
    Framework7.prototype.init = function () {
        var app = this;
        if (app.initialized)
            return;
    ...
    Framework7.Class = function () {
        var args = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            args[_i] = arguments[_i];
        }
        return new (Framework7Class.bind.apply(Framework7Class, __spread([void 0], args)))();
    };
    return Framework7;
}(Framework7Class));
...
var Resize = {
    ...
    instance: {
        getSize: function () {
            ...
            var _a = __read([app.root[0].offsetWidth, app.root[0].offsetHeight, offset.left, offset.top], 4), width = _a[0], height = _a[1], left = _a[2], top = _a[3];
            app.width = width;
            app.height = height;
            app.left = left;
            app.top = top;
    ...
    function targetNeedsFastClick(el) {
        ...
        */
        ...
        if (el.nodeName.toLowerCase() === 'input' && (el.type === 'file' || el.type === 'range'))
            return false;
        if (el.nodeName.toLowerCase() === 'select' && Device$1.android)
            return false;
        if ($el.hasClass('no-fastclick') || $el.parents('.no-fastclick').length > 0)
            return false;
        if (params.fastClicksExclude && $el.is(params.fastClicksExclude))
            return false;
        return true;
    }
...
var Framework7Component = (function () {
    function Framework7Component(c, extend) {
        ...
        ('beforeCreate created beforeMount mounted beforeDestroy destroyed').split(' ').forEach(function (cycleKey) {
            if (component[cycleKey])
                component[cycleKey] = component[cycleKey].bind(context);
        });
        if (component.data) {
        ...
        if (component.render)
            component.render = component.render.bind(context);
                    ...
                    events.push({
                        ...
                        handler: function () {
                            ...
                            if (value_1.indexOf('(') < 0) {
                                ...
                                methodName = value_1.split('(')[0];
                                value_1.split('(')[1].split(')')[0].split(',').forEach(function (argument) {
                            ...
                            method.apply(void 0, __spread(customArgs));
                        },
                    });
                }
            };
...
var Component = {
    parse: function (componentString) {
    ...
    create: function (c, extendContext) {
...
function SwipeBack(r) {
    var router = r;
    var $el = router.$el, $navbarEl = router.$navbarEl, app = router.app;
    var isTouched = false;
    var isMoved = false;
    var touchesStart = {};
    var isScrolling;
    ...
    var navbarWidth;
    function handleTouchStart(e) {
        if (!allowViewTouchMove || !router.params.swipeBackPage || isTouched || app.swipeout.el || !router.allowPageChange)
            return;
        isMoved = false;
        isTouched = true;
    ...
    function handleTouchMove(e) {
        ...
        if (!isMoved) {
            ...
            if (currentPage.hasClass('no-swipeback'))
                cancel = true;
            ...
            if (notFromBorder)
                cancel = true;
            if (previousPage.length === 0 || currentPage.length === 0)
                cancel = true;
            if (cancel) {
                isTouched = false;
                return;
        ...
        if (dynamicNavbar) {
            currentNavElements.each(function (index, navEl) {
                ...
                if (!$navEl.is('.subnavbar'))
                    $navEl[0].style.opacity = (1 - (percentage * 1.3));
            ...
            previousNavElements.each(function (index, navEl) {
                var $navEl = dom7$1(navEl);
                if (!$navEl.is('.subnavbar'))
                    $navEl[0].style.opacity = (percentage * 1.3) - 0.3;
    ...
    function handleTouchEnd() {
        ...
        if ((timeDiff < 300 && touchesDiff > 10) ||
            ...
            if (pageShadow)
                pageShadow[0].style.opacity = '';
            if (pageOpacity)
                pageOpacity[0].style.opacity = '';
            if (dynamicNavbar) {
        ...
        if (dynamicNavbar) {
            currentNavElements.css({ opacity: '' })
                ...
                if (!separateNavbar && pageChanged)
                    iconTranslate -= navbarWidth;
        ...
        currentPage.transitionEnd(function () {
            ...
            if (dynamicNavbar) {
                ...
                if (activeNavBackIcon && activeNavBackIcon.length > 0)
                    activeNavBackIcon.removeClass('navbar-transitioning');
                if (previousNavBackIcon && previousNavBackIcon.length > 0)
                    previousNavBackIcon.removeClass('navbar-transitioning');
            }
...
function load(loadParams, loadOptions, ignorePageChange) {
    ...
    var url = params.url, content = params.content, el = params.el, name = params.name, template = params.template, templateUrl = params.templateUrl, component = params.component, componentUrl = params.componentUrl;
...
function navigate(url, navigateOptions) {
    ...
    ('url content name el component componentUrl template templateUrl').split(' ').forEach(function (pageLoadProp) {
        if (route.route[pageLoadProp]) {
            router.load((_a = {}, _a[pageLoadProp] = route.route[pageLoadProp], _a), options);
        }
        var _a;
    });
    // Async
...
function tabLoad(tabRoute, loadOptions) {
    ...
    // Show Tab
    var _a = router.app.tab.show("#" + tabRoute.id, options.animate, options.route), $newTabEl = _a.$newTabEl, $oldTabEl = _a.$oldTabEl;
    // Load Tab Content
    var url = tabRoute.url, content = tabRoute.content, el = tabRoute.el, template = tabRoute.template, templateUrl = tabRoute.templateUrl, component = tabRoute.component, componentUrl = tabRoute.componentUrl;
...
function modalLoad(modalType, route, loadOptions) {
    ...
    var ignoreCache = options.ignoreCache;
    // Load Modal Props
    var url = modalParams.url, template = modalParams.template, templateUrl = modalParams.templateUrl, component = modalParams.component, componentUrl = modalParams.componentUrl;
...
function back() {
    ...
    ('url content name el component componentUrl template templateUrl').split(' ').forEach(function (pageLoadProp) {
        if (route.route[pageLoadProp]) {
            router.loadBack((_a = {}, _a[pageLoadProp] = route.route[pageLoadProp], _a), options);
        }
        var _a;
    });
    // Async
...
var Router$1 = (function (_super) {
    __extends(Router, _super);
    function Router(app, view) {
        var _this = _super.call(this, {}, [typeof view === 'undefined' ? app : view]) || this;
        var router = _this;
        // Is App Router
    ...
    Router.prototype.animateWithCSS = function (oldPage, newPage, oldNavbarInner, newNavbarInner, direction, callback) {
        var router = this;
    ...
    Router.prototype.animateWithJS = function (oldPage, newPage, oldNavbarInner, newNavbarInner, direction, callback) {
        var router = this;
        var dynamicNavbar = router.dynamicNavbar;
        var separateNavbar = router.separateNavbar;
        var animateIcon = router.params.iosAnimateNavbarBackIcon;
    ...
    Router.prototype.animate = function () {
        var args = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            args[_i] = arguments[_i];
        }
        ...
        if (router.params.animateCustom) {
            ...
            router.animateWithJS.apply(router, __spread(args));
        }
        else {
            router.animateWithCSS.apply(router, __spread(args));
        }
    };
    Router.prototype.removeEl = function (el) {
        if (!el)
            return;
        var router = this;
        var $el = dom7$1(el);
    ...
    Router.prototype.getPageEl = function (content) {
        var router = this;
    ...
    Router.prototype.findElement = function (stringSelector, container, notStacked) {
        var router = this;
        var view = router.view;
        var app = router.app;
        // Modals Selector
        ...
        if (found && found.length === 1)
            return found;
        if (found && found.length > 1)
            return dom7$1(found[0]);
        return undefined;
    };
    Router.prototype.flattenRoutes = function (routes) {
        var _this = this;
        ...
        routes.forEach(function (route) {
            if ('routes' in route) {
                ...
                flattenedRoutes = flattenedRoutes.concat(route, _this.flattenRoutes(mergedPathsRoutes));
            }
                ...
                flattenedRoutes = flattenedRoutes.concat(_this.flattenRoutes(mergedPathsRoutes));
            }
            else {
    ...
    Router.prototype.findMatchingRoute = function (url, parseOnly) {
        if (!url)
            return undefined;
        var router = this;
    ...
    Router.prototype.removeFromXhrCache = function (url) {
        var router = this;
    ...
    Router.prototype.xhrRequest = function (requestUrl, ignoreCache) {
        var router = this;
    ...
    // Remove theme elements
    Router.prototype.removeThemeElements = function (el) {
        var router = this;
        var theme = router.app.theme;
        dom7$1(el).find("." + (theme === 'md' ? 'ios' : 'md') + "-only, .if-" + (theme === 'md' ? 'ios' : 'md')).remove();
    };
    Router.prototype.templateLoader = function (template, templateUrl, options, resolve, reject) {
        var router = this;
        function compile(t) {
            var compiledHtml;
            var context;
            try {
                ...
                if (typeof context === 'function')
                    context = context.call(router.app);
    ...
    Router.prototype.modalTemplateLoader = function (template, templateUrl, options, resolve, reject) {
        var router = this;
        return router.templateLoader(template, templateUrl, options, function (html) {
            resolve(html);
        }, reject);
    };
    Router.prototype.tabTemplateLoader = function (template, templateUrl, options, resolve, reject) {
        var router = this;
        return router.templateLoader(template, templateUrl, options, function (html) {
            resolve(html);
        }, reject);
    };
    Router.prototype.pageTemplateLoader = function (template, templateUrl, options, resolve, reject) {
        var router = this;
    ...
    Router.prototype.componentLoader = function (component, componentUrl, options, resolve, reject) {
        var router = this;
    ...
    Router.prototype.modalComponentLoader = function (rootEl, component, componentUrl, options, resolve, reject) {
        var router = this;
        router.componentLoader(component, componentUrl, options, function (el) {
            resolve(el);
        }, reject);
    };
    Router.prototype.tabComponentLoader = function (tabEl, component, componentUrl, options, resolve, reject) {
        var router = this;
        router.componentLoader(component, componentUrl, options, function (el) {
            resolve(el);
        }, reject);
    };
    Router.prototype.pageComponentLoader = function (routerEl, component, componentUrl, options, resolve, reject) {
        var router = this;
    ...
    Router.prototype.getPageData = function (pageEl, navbarEl, from, to, route, pageFromEl) {
    ...
    // Callbacks
    Router.prototype.pageCallback = function (callback, pageEl, navbarEl, from, to, options, pageFromEl) {
        if (options === void 0) { options = {}; }
        if (!pageEl)
            return;
        var router = this;
        var $pageEl = dom7$1(pageEl);
        var route = options.route, _a = options.on, on = _a === void 0 ? {} : _a;
        ...
        function attachEvents() {
            if ($pageEl[0].f7PageEventsAttached)
                return;
    ...
    Router.prototype.saveHistory = function () {
        var router = this;
    ...
    Router.prototype.restoreHistory = function () {
        var router = this;
...
var Router = {
    ...
    create: function (params) {
        var instance = this;
        var app = params.app, view = params.view;
        if (view) {
            // View Router
...
var View = (function (_super) {
    ...
    function View(appInstance, el, viewParams) {
        ...
        var _this = _super.call(this, viewParams, [appInstance]) || this;
        var app = appInstance;
        var $el = dom7$1(el);
        var view = _this;
        var defaults = {
            ...
            if (clickedLinkData.view) {
                ...
                if (view && view.params.linksView) {
                    if (typeof view.params.linksView === 'string')
                        view = dom7$1(view.params.linksView)[0].f7View;
...
var Statusbar = {
    ...
    setIosTextColor: function (color) {
        if (Device$1.cordova && window.StatusBar) {
            if (color === 'white') {
...
var Statusbar$1 = {
    ...
    clicks: {
        '.statusbar': function onStatusbarClick() {
            var app = this;
            if (!app.params.statusbar.scrollTopOnClick)
                return;
...
var View$2 = {
    ...
    on: {
        ...
        modalBeforeDestroy: function (modal) {
            if (!modal || !modal.$el)
                return;
            modal.$el.find('.view-init').each(function (index, viewEl) {
...
var Navbar = {
    ...
    hide: function (el, animate) {
        ...
        var $el = dom7$1(el);
        if ($el.hasClass('navbar-inner'))
            $el = $el.parents('.navbar');
        if (!$el.length)
            return;
    ...
    initHideNavbarOnScroll: function (pageEl, navbarInnerEl) {
        var app = this;
        var $pageEl = dom7$1(pageEl);
    ...
    on: {
        ...
        pageInit: function (page) {
            ...
            if (app.params.navbar.hideOnPageScroll || page.$el.find('.hide-navbar-on-scroll').length || page.$el.hasClass('hide-navbar-on-scroll') || page.$el.find('.hide-bars-on-scroll').length) {
                if (page.$el.find('.keep-navbar-on-scroll').length || page.$el.find('.keep-bars-on-scroll').length)
                    return;
...
var Toolbar = {
    setHighlight: function (tabbarEl) {
        var app = this;
        if (app.theme !== 'md')
            return;
    ...
    initHideToolbarOnScroll: function (pageEl) {
        var app = this;
        var $pageEl = dom7$1(pageEl);
    ...
    on: {
        ...
        pageInit: function (page) {
            ...
            if (app.params.toolbar.hideOnPageScroll || page.$el.find('.hide-toolbar-on-scroll').length || page.$el.hasClass('hide-toolbar-on-scroll') || page.$el.find('.hide-bars-on-scroll').length) {
                if (page.$el.find('.keep-toolbar-on-scroll').length || page.$el.find('.keep-bars-on-scroll').length)
                    return;
    ...
    create: function () {
        ...
        app.touchRipple = {
            create: function () {
                ...
                return new (TouchRipple$1.bind.apply(TouchRipple$1, __spread([void 0], args)))();
            },
        };
    },
};
...
var Modal$1 = (function (_super) {
    ...
    function Modal(app, params) {
        var _this = _super.call(this, params, [app]) || this;
        var modal = _this;
        var defaults = {};
        // Extend defaults with modules params
    ...
    Modal.prototype.open = function (animate) {
        if (animate === void 0) { animate = true; }
        var modal = this;
        var app = modal.app;
        var $el = modal.$el;
    ...
    Modal.prototype.close = function (animate) {
        if (animate === void 0) { animate = true; }
        var modal = this;
        var $el = modal.$el;
        var $backdropEl = modal.$backdropEl;
...
var Dialog$1 = (function (_super) {
    ...
    function Dialog(app, params) {
        ...
        _this = _super.call(this, app, extendedParams) || this;
        var dialog = _this;
        var title = extendedParams.title, text = extendedParams.text, content = extendedParams.content, buttons = extendedParams.buttons, verticalButtons = extendedParams.verticalButtons, cssClass = extendedParams.cssClass;
...
var Dialog = {
    ...
    create: function () {
        ...
        Utils$1.extend(app, {
            dialog: {
                ...
                open: function (dialogEl, animate) {
                    var $dialogEl = dom7$1(dialogEl);
                    var dialog = $dialogEl[0].f7Modal;
                    if (!dialog)
                        dialog = new Dialog$1(app, { el: $dialogEl });
                    return dialog.open(animate);
                },
                close: function (dialogEl, animate) {
                ...
                alert: function () {
                    ...
                    var _a = __read(args, 3), text = _a[0], title = _a[1], callbackOk = _a[2];
                    if (args.length === 2 && typeof args[1] === 'function') {
                        _b = __read(args, 3), text = _b[0], callbackOk = _b[1], title = _b[2];
                    }
                ...
                prompt: function () {
                    ...
                    var _a = __read(args, 4), text = _a[0], title = _a[1], callbackOk = _a[2], callbackCancel = _a[3];
                    if (typeof args[1] === 'function') {
                        _b = __read(args, 4), text = _b[0], callbackOk = _b[1], callbackCancel = _b[2], title = _b[3];
                    }
                    return new Dialog$1(app, {
                        title: typeof title === 'undefined' ? app.params.modals.dialogTitle : title,
                        text: text,
                ...
                progress: function () {
                    ...
                    var _a = __read(args, 3), title = _a[0], progress = _a[1], color = _a[2];
                    if (args.length === 2) {
                        if (typeof args[0] === 'number') {
                            _b = __read(args, 3), progress = _b[0], color = _b[1], title = _b[2];
                        }
                        else if (typeof args[0] === 'string' && typeof args[1] === 'string') {
                            _c = __read(args, 3), title = _c[0], color = _c[1], progress = _c[2];
                        }
                    }
                    else if (args.length === 1) {
                        if (typeof args[0] === 'number') {
                            _d = __read(args, 3), progress = _d[0], title = _d[1], color = _d[2];
                        }
                    }
    ...
    clicks: {
        '.dialog-backdrop': function closeDialog() {
            var app = this;
            if (!app.params.modals.dialogCloseByBackdropClick)
                return;
            app.dialog.close();
        },
    },
...
var Popup = {
    ...
    create: function () {
        ...
        Utils$1.extend(app, {
            popup: {
                ...
                open: function (popupEl, animate) {
                    var $popupEl = dom7$1(popupEl);
                    var popup = $popupEl[0].f7Modal;
                    if (!popup)
                        popup = new Popup$1(app, { el: $popupEl });
                    return popup.open(animate);
                },
                close: function (popupEl, animate) {
    ...
    clicks: {
        ...
        '.popup-backdrop': function closePopup() {
            var app = this;
            if (!app.params.modals.popupCloseByBackdropClick)
                return;
            app.popup.close();
        },
    },
...
var LoginScreen$1 = (function (_super) {
...
var Popover$1 = (function (_super) {
    ...
    function Popover(app, params) {
        ...
        Utils$1.extend(popover, {
            ...
            open: function () {
                ...
                var _a = __read(args, 2), targetEl = _a[0], animate = _a[1];
                if (typeof args[0] === 'boolean')
                    _b = __read(args, 2), animate = _b[0], targetEl = _b[1];
                if (targetEl) {
    ...
    Popover.prototype.resize = function () {
        var popover = this;
        var app = popover.app, $el = popover.$el, $targetEl = popover.$targetEl, $angleEl = popover.$angleEl;
        $el.css({ left: '', top: '' });
        var _a = __read([$el.width(), $el.height()], 2), width = _a[0], height = _a[1];
        var angleSize = 0;
        var angleLeft;
        var angleTop;
        if (app.theme === 'ios') {
        ...
        var _b = __read([0, 0, 0], 3), left = _b[0], top = _b[1], diff = _b[2];
        // Top Position
        ...
        if (app.theme === 'md') {
            ...
            if (position === 'top' || position === 'bottom') {
                ...
                if (left < 5)
                    left = 5;
                if (left + width > app.width)
                    left = app.width - width - 5;
                if (left < 0)
                    left = 0;
                if (position === 'top') {
...
var Popover = {
    ...
    create: function () {
        ...
        Utils$1.extend(app, {
            popover: {
                ...
                open: function (popoverEl, targetEl, animate) {
                    var $popoverEl = dom7$1(popoverEl);
                    var popover = $popoverEl[0].f7Modal;
                    if (!popover)
                        popover = new Popover$1(app, { el: $popoverEl, targetEl: targetEl });
                    return popover.open(targetEl, animate);
                },
                close: function (popoverEl, animate) {
                    ...
                    var popover = $popoverEl[0].f7Modal;
                    if (!popover)
                        popover = new Popover$1(app, { el: $popoverEl });
                    return popover.close(animate);
                },
                get: function (popoverEl) {
                    if (popoverEl === void 0) { popoverEl = '.popover.modal-in'; }
                    var $popoverEl = dom7$1(popoverEl);
                    if ($popoverEl.length === 0)
                        return undefined;
    ...
    clicks: {
        ...
        '.popover-backdrop': function closePopover() {
            var app = this;
            if (!app.params.modals.popoverCloseByBackdropClick)
                return;
            app.popover.close();
        },
    },
        ...
        if (actions.params.el) {
            ...
            if (actions.params.toPopover) {
                actions.popoverHtml = "\n          <div class=\"popover popover-from-actions\">\n            <div class=\"popover-inner\">\n              " + groups.map(function (group) { return "\n                <div class=\"list\">\n                  <ul>\n                    " + group.map(function (button) {
                    var itemClasses = [];
                    if (button.color)
                        itemClasses.push("color-" + button.color);
                    if (button.bg)
                        itemClasses.push("bg-" + button.bg);
                    if (button.bold)
            ...
            actions.actionsHtml = "\n        <div class=\"actions-modal" + (actions.params.grid ? ' actions-grid' : '') + "\">\n          " + groups.map(function (group) {
                return "<div class=\"actions-group\">\n              " + group.map(function (button) {
                    ...
                    if (button.color)
                        buttonClasses.push("color-" + button.color);
                    if (button.bg)
                        buttonClasses.push("bg-" + button.color);
                    if (button.bold)
...
var Actions = {
    ...
    clicks: {
        ...
        '.actions-backdrop': function closeActions() {
            var app = this;
            if (!app.params.modals.actionsCloseByBackdropClick)
                return;
            app.actions.close();
        },
    },
...
var Sheet = {
    ...
    create: function () {
        ...
        Utils$1.extend(app, {
            sheet: {
                ...
                open: function (sheetEl, animate) {
                    var $sheetEl = dom7$1(sheetEl);
                    var sheet = $sheetEl[0].f7Modal;
                    if (!sheet)
                        sheet = new Sheet$1(app, { el: $sheetEl });
                    return sheet.open(animate);
                },
                close: function (sheetEl, animate) {
    ...
    clicks: {
        ...
        '.sheet-backdrop': function closePopup() {
            var app = this;
            if (!app.params.modals.sheetCloseByBackdropClick)
                return;
            app.sheet.close();
        },
    },
...
var Preloader = {
    init: function (el) {
        ...
        if (app.theme !== 'md')
            return;
        var $el = dom7$1(el);
        if ($el.length === 0 || $el.children('.preloader-inner').length > 0)
            return;
        $el.append('<span class="preloader-inner">' +
            '<span class="preloader-inner-gap"></span>' +
            '<span class="preloader-inner-left">' +
            '<span class="preloader-inner-half-circle"></span>' +
            '</span>' +
...
var Progressbar = {
    set: function () {
        ...
        var app = this;
        var _a = __read(args, 3), el = _a[0], progress = _a[1], duration = _a[2];
        if (typeof args[0] === 'number') {
            _b = __read(args, 2), progress = _b[0], duration = _b[1];
            el = app.root;
        }
        if (!progress)
            progress = 0;
    ...
    show: function () {
        ...
        var app = this;
        // '.page', 50, 'multi'
        var _a = __read(args, 3), el = _a[0], progress = _a[1], color = _a[2];
        var type = 'determined';
        if (args.length === 2) {
            if ((typeof args[0] === 'string' || typeof args[0] === 'object') && typeof args[1] === 'string') {
                // '.page', 'multi'
                _b = __read(args, 3), el = _b[0], color = _b[1], progress = _b[2];
                type = 'infinite';
            }
            else if (typeof args[0] === 'number' && typeof args[1] === 'string') {
                // 50, 'multi'
                _c = __read(args, 2), progress = _c[0], color = _c[1];
                el = app.root;
            }
        }
        else if (args.length === 1) {
    ...
    hide: function (el, removeAfterHide) {
...
var Swipeout = {
    init: function () {
        ...
        function handleTouchMove(e) {
            ...
            if (!isMoved) {
                if (dom7$1('.list.sortable-opened').length > 0)
                    return;
            ...
            if ((translate > 0 && $actionsLeft.length === 0)
                ||
            ...
            if ($actionsRight.length > 0) {
                // Show right actions
                var buttonTranslate_1 = translate;
                progress = buttonTranslate_1 / actionsRightWidth;
                if (buttonTranslate_1 < -actionsRightWidth) {
                    buttonTranslate_1 = -actionsRightWidth - (Math.pow((-buttonTranslate_1 - actionsRightWidth), 0.8));
                    translate = buttonTranslate_1;
                ...
                $rightButtons.each(function (index, buttonEl) {
                    ...
                    $buttonEl.transform("translate3d(" + (buttonTranslate_1 - (buttonOffset * (1 + Math.max(progress, -1)))) + "px,0,0)");
                });
            }
            if ($actionsLeft.length > 0) {
                // Show left actions
                var buttonTranslate_2 = translate;
                progress = buttonTranslate_2 / actionsLeftWidth;
                if (buttonTranslate_2 > actionsLeftWidth) {
                    buttonTranslate_2 = actionsLeftWidth + (Math.pow((buttonTranslate_2 - actionsLeftWidth), 0.8));
                    translate = buttonTranslate_2;
                ...
                $leftButtons.each(function (index, buttonEl) {
                    ...
                    $buttonEl.transform("translate3d(" + (buttonTranslate_2 + (buttonOffset * (1 - Math.min(progress, 1)))) + "px,0,0)");
                });
            }
        ...
        app.on('touchstart', function (e) {
            if (Swipeout.el) {
                ...
                if (!(dom7$1(Swipeout.el).is($targetEl[0]) ||
    ...
    open: function () {
        ...
        var app = this;
        var _a = __read(args, 3), el = _a[0], side = _a[1], callback = _a[2];
        if (typeof args[1] === 'function') {
            _b = __read(args, 3), el = _b[0], callback = _b[1], side = _b[2];
        }
...
var Swipeout$1 = {
    ...
    clicks: {
        ...
        '.swipeout-delete': function deleteSwipeout($clickedEl, data) {
            ...
            if ($swipeoutEl.length === 0)
                return;
            var confirm = data.confirm, confirmTitle = data.confirmTitle;
            if (data.confirm) {
...
var Accordion = {
    toggleClicked: function ($clickedEl) {
        var app = this;
...
var VirtualList$1 = (function (_super) {
    ...
    VirtualList.prototype.setListSize = function () {
        var vl = this;
    ...
    VirtualList.prototype.render = function (force, forceScrollTop) {
        var vl = this;
        if (force)
    ...
    // Filter
    VirtualList.prototype.filterItems = function (indexes, resetScrollTop) {
    ...
    VirtualList.prototype.resetFilter = function () {
        var vl = this;
        if (vl.params.showFilteredItemsOnly) {
            vl.filteredItems = [];
        }
    ...
    // Handle resize event
    VirtualList.prototype.isVisible = function () {
        var vl = this;
        return !!(vl.el.offsetWidth || vl.el.offsetHeight || vl.el.getClientRects().length);
    };
    VirtualList.prototype.handleResize = function () {
        var vl = this;
        if (vl.isVisible()) {
            vl.setListSize();
            vl.render(true);
    ...
    // Append
    VirtualList.prototype.appendItems = function (items) {
        var vl = this;
        for (var i = 0; i < items.length; i += 1) {
    ...
    VirtualList.prototype.appendItem = function (item) {
        var vl = this;
        vl.appendItems([item]);
    };
    // Replace
    VirtualList.prototype.replaceAllItems = function (items) {
        var vl = this;
        vl.items = items;
        delete vl.filteredItems;
        vl.domCache = {};
    ...
    VirtualList.prototype.replaceItem = function (index, item) {
        var vl = this;
        vl.items[index] = item;
        if (vl.params.cache)
    ...
    // Prepend
    VirtualList.prototype.prependItems = function (items) {
        var vl = this;
        ...
        if (vl.params.cache) {
            ...
            Object.keys(vl.domCache).forEach(function (cached) {
                newCache_1[parseInt(cached, 10) + items.length] = vl.domCache[cached];
            });
            vl.domCache = newCache_1;
        }
        vl.update();
    };
    VirtualList.prototype.prependItem = function (item) {
        var vl = this;
        vl.prependItems([item]);
    };
    // Move
    VirtualList.prototype.moveItem = function (from, to) {
        var vl = this;
        var fromIndex = from;
        var toIndex = to;
        ...
        if (vl.params.cache) {
            ...
            Object.keys(vl.domCache).forEach(function (cached) {
                ...
                if (cachedIndex < leftIndex || cachedIndex > rightIndex)
                    newCache_2[cachedIndex] = vl.domCache[cachedIndex];
                if (cachedIndex === leftIndex)
                    newCache_2[rightIndex] = vl.domCache[cachedIndex];
                if (cachedIndex > leftIndex && cachedIndex <= rightIndex)
                    newCache_2[cachedIndex + indexShift] = vl.domCache[cachedIndex];
            });
            vl.domCache = newCache_2;
        }
        vl.update();
    };
    // Insert before
    VirtualList.prototype.insertItemBefore = function (index, item) {
        var vl = this;
        if (index === 0) {
            vl.prependItem(item);
            return;
        ...
        if (vl.params.cache) {
            ...
            Object.keys(vl.domCache).forEach(function (cached) {
                ...
                if (cachedIndex >= index) {
                    newCache_3[cachedIndex + 1] = vl.domCache[cachedIndex];
                }
            });
            vl.domCache = newCache_3;
        }
        vl.update();
    };
    // Delete
    VirtualList.prototype.deleteItems = function (indexes) {
        var vl = this;
        var prevIndex;
        var indexShift = 0;
        var _loop_1 = function (i) {
            ...
            if (vl.params.cache) {
                ...
                Object.keys(vl.domCache).forEach(function (cached) {
                    ...
                    if (cachedIndex === index) {
                        ...
                        newCache_4[cachedIndex - 1] = vl.domCache[cached];
                    }
                    else {
                        newCache_4[cachedIndex] = vl.domCache[cached];
                    }
                });
                vl.domCache = newCache_4;
            }
        };
        for (var i = 0; i < indexes.length; i += 1) {
            _loop_1(i);
    ...
    VirtualList.prototype.deleteAllItems = function () {
        var vl = this;
        vl.items = [];
        delete vl.filteredItems;
        if (vl.params.cache)
    ...
    VirtualList.prototype.deleteItem = function (index) {
        var vl = this;
        vl.deleteItems([index]);
    };
    // Clear cache
    VirtualList.prototype.clearCachefunction = function () {
        var vl = this;
        vl.domCache = {};
    };
    // Update Virtual List
...
var Tab = {
    show: function () {
        ...
        var app = this;
        var _a = __read(args, 4), tab = _a[0], tabLink = _a[1], animate = _a[2], tabRoute = _a[3];
        if (typeof args[1] === 'boolean') {
            _b = __read(args, 4), tab = _b[0], animate = _b[1], tabLink = _b[2], tabRoute = _b[3];
            if (args.length > 2 && tabLink.constructor === Object) {
                _c = __read(args, 4), tab = _c[0], animate = _c[1], tabRoute = _c[2], tabLink = _c[3];
            }
        }
        ...
        if (!$tabLinkEl) {
            ...
            if (typeof tab === 'string')
                $tabLinkEl = dom7$1(".tab-link[href=\"" + tab + "\"]");
            else
                $tabLinkEl = dom7$1(".tab-link[href=\"#" + $newTabEl.attr('id') + "\"]");
            // Search by data-tab
            if (!$tabLinkEl || ($tabLinkEl && $tabLinkEl.length === 0)) {
                dom7$1('[data-tab]').each(function (index, el) {
                    if ($newTabEl.is(dom7$1(el).attr('data-tab')))
                        $tabLinkEl = dom7$1(el);
                });
            }
        ...
        if ($tabLinkEl.length > 0) {
            ...
            if ($oldTabEl && $oldTabEl.length > 0) {
                ...
                if (oldTabId)
                    $oldTabLinkEl_1 = dom7$1(".tab-link[href=\"#" + oldTabId + "\"]");
                // Search by data-tab
                if (!$oldTabLinkEl_1 || ($oldTabLinkEl_1 && $oldTabLinkEl_1.length === 0)) {
                    dom7$1('[data-tab]').each(function (index, tabLinkEl) {
                        if ($oldTabEl.is(dom7$1(tabLinkEl).attr('data-tab')))
                            $oldTabLinkEl_1 = dom7$1(tabLinkEl);
                    });
                }
                if (!$oldTabLinkEl_1 || ($oldTabLinkEl_1 && $oldTabLinkEl_1.length === 0)) {
                    $oldTabLinkEl_1 = $tabLinkEl.siblings('.tab-link-active');
                }
            }
            if ($oldTabLinkEl_1 && $oldTabLinkEl_1.length > 0)
                $oldTabLinkEl_1.removeClass('tab-link-active');
...
function swipePanel(panel) {
    ...
    var $el = panel.$el, $backdropEl = panel.$backdropEl, side = panel.side, effect = panel.effect, $viewEl = panel.$viewEl;
    var otherPanel;
    var isTouched;
    var isMoved;
    var isScrolling;
    ...
    function handleTouchStart(e) {
        ...
        if (!app.panel.allowOpen || (!params.swipe && !params.swipeOnlyClose) || isTouched)
            return;
        if (dom7$1('.modal-in, .photo-browser-in').length > 0)
            return;
        otherPanel = app.panel[side === 'left' ? 'right' : 'left'] || {};
        if (!panel.opened && otherPanel.opened)
            return;
        if (!(params.swipeCloseOpposite || params.swipeOnlyClose)) {
            if (otherPanel.opened)
                return;
        }
        if (e.target && e.target.nodeName.toLowerCase() === 'input' && e.target.type === 'range')
            return;
        if (dom7$1(e.target).closest('.range-slider').length > 0)
            return;
        if (dom7$1(e.target).closest('.tabs-swipeable-wrap').length > 0)
            return;
        touchesStart.x = e.type === 'touchstart' ? e.targetTouches[0].pageX : e.pageX;
        touchesStart.y = e.type === 'touchstart' ? e.targetTouches[0].pageY : e.pageY;
        ...
        if (params.swipeNoFollow) {
            ...
            if (timeDiff < 300) {
                if (direction === 'to-left') {
                    if (side === 'right')
                        app.openPanel(side);
                    if (side === 'left' && $el.hasClass('panel-active'))
                        app.closePanel();
                }
                if (direction === 'to-right') {
                    if (side === 'left')
                        app.openPanel(side);
                    if (side === 'right' && $el.hasClass('panel-active'))
                        app.closePanel();
                }
            }
            isTouched = false;
...
var Panel$1 = (function (_super) {
    ...
    function Panel(app, params) {
        ...
        if ($el[0].f7Panel)
            return $el[0].f7Panel;
        $el[0].f7Panel = panel;
        var opened = params.opened, side = params.side, effect = params.effect;
        if (typeof opened === 'undefined')
            opened = $el.hasClass('panel-active');
        if (typeof side === 'undefined')
            side = $el.hasClass('panel-left') ? 'left' : 'right';
        if (typeof effect === 'undefined')
            effect = $el.hasClass('panel-cover') ? 'cover' : 'reveal';
        if (!app.panel[side]) {
            Utils$1.extend(app.panel, (_a = {},
                _a[side] = panel,
                _a));
        }
    ...
    Panel.prototype.init = function () {
        ...
        if ((app.params.panel.swipe === panel.side)
            ||
    ...
    Panel.prototype.setBreakpoint = function () {
        var panel = this;
        var app = panel.app;
        var side = panel.side, $el = panel.$el, $viewEl = panel.$viewEl;
    ...
    Panel.prototype.initBreakpoints = function () {
        var panel = this;
        var app = panel.app;
    ...
    Panel.prototype.initSwipePanel = function () {
        swipePanel(this);
    };
    ...
    Panel.prototype.open = function (animate) {
        if (animate === void 0) { animate = true; }
        var panel = this;
        var app = panel.app;
        if (!app.panel.allowOpen)
            return false;
        var side = panel.side, effect = panel.effect, $el = panel.$el, $backdropEl = panel.$backdropEl;
    ...
    Panel.prototype.close = function (animate) {
        if (animate === void 0) { animate = true; }
        var panel = this;
        var app = panel.app;
        var side = panel.side, effect = panel.effect, $el = panel.$el, $backdropEl = panel.$backdropEl;
        if ($el.hasClass('panel-visible-by-breakpoint') || !$el.hasClass('panel-active'))
            return false;
        $el[animate ? 'removeClass' : 'addClass']('not-animated');
        ...
        Utils$1.extend(app.panel, {
            disableSwipe: function (panel) {
                ...
                panels.forEach(function (panelInstance) {
                    if (panelInstance)
                        Utils$1.extend(panelInstance, { swipeable: false });
                });
            },
            enableSwipe: function (panel) {
                if (panel === void 0) { panel = 'both'; }
                var panels = [];
                var side;
                if (typeof panel === 'string') {
                    side = panel;
                    if ((app.params.panel.swipe === 'left' && side === 'right') ||
...
function initAjaxForm() {
    ...
    function onSubmitChange(e, fromData) {
        ...
        var data;
        if (method === 'POST')
            data = new FormData$1($formEl[0]);
        else
            data = dom7$1.serializeObject(app.form.toData($formEl[0]));
        var xhr = dom7$1.ajax({
            method: method,
            url: url,
...
var Input = {
    ...
    resizeTextarea: function (textareaEl) {
        var app = this;
    ...
    create: function () {
        ...
        Utils$1.extend(app, {
            toggle: {
                ...
                destroy: function (el) {
                    if (el && (el instanceof Toggle$1) && el.destroy)
                        return el.destroy();
                    var $el = dom7$1(el);
                    if ($el.length)
                        return $el[0].f7Toggle.destroy();
                    return undefined;
                },
            },
        });
...
var Range$1 = (function (_super) {
    ...
    Range.prototype.calcSize = function () {
        var range = this;
    ...
    Range.prototype.layout = function () {
        var range = this;
        var knobWidth = range.knobWidth, rangeWidth = range.rangeWidth, min = range.min, max = range.max, knobs = range.knobs, $barActiveEl = range.$barActiveEl, value = range.value, label = range.label, labels = range.labels;
        if (range.dual) {
            var progress_1 = [((value[0] - min) / (max - min)), ((value[1] - min) / (max - min))];
            $barActiveEl.css({
                left: progress_1[0] * 100 + "%",
                width: (progress_1[1] - progress_1[0]) * 100 + "%",
            });
            knobs.forEach(function ($knobEl, knobIndex) {
                var leftPos = rangeWidth * progress_1[knobIndex];
                var realLeft = (rangeWidth * progress_1[knobIndex]) - (knobWidth / 2);
                if (realLeft < 0)
                    leftPos = knobWidth / 2;
                if ((realLeft + knobWidth) > rangeWidth)
                    leftPos = rangeWidth - (knobWidth / 2);
                $knobEl.css('left', leftPos + "px");
                if (label)
                    labels[knobIndex].text(value[knobIndex]);
            });
        }
        else {
            var progress = ((value - min) / (max - min));
            $barActiveEl.css('width', progress * 100 + "%");
            var leftPos = rangeWidth * progress;
            var realLeft = (rangeWidth * progress) - (knobWidth / 2);
            if (realLeft < 0)
                leftPos = knobWidth / 2;
            if ((realLeft + knobWidth) > rangeWidth)
                leftPos = rangeWidth - (knobWidth / 2);
    ...
    create: function () {
        ...
        Utils$1.extend(app, {
            range: {
                ...
                destroy: function (el) {
                    if (el && (el instanceof Range$1) && el.destroy)
                        return el.destroy();
                    var $el = dom7$1(el);
                    if ($el.length)
                        return $el[0].f7Range.destroy();
                    return undefined;
                },
                get: function (el) {
                    var $el = dom7$1(el);
                ...
                getValue: function (el) {
                    var $el = dom7$1(el);
                    if ($el.length)
                        return $el[0].f7Range.get();
                    return undefined;
                },
                setValue: function (el, value) {
                    var $el = dom7$1(el);
                    if ($el.length)
                        return $el[0].f7Range.set(value);
                    return undefined;
                },
            },
        });
...
var SmartSelect$1 = (function (_super) {
    ...
    SmartSelect.prototype.checkMaxLength = function () {
        var ss = this;
    ...
    SmartSelect.prototype.setValue = function (value) {
        var ss = this;
        var valueArray = [];
        if (typeof value !== 'undefined') {
    ...
    SmartSelect.prototype.getItemsData = function () {
        var ss = this;
        var items = [];
        var previousGroupEl;
    ...
    SmartSelect.prototype.onOpen = function (type, container) {
        var ss = this;
        var app = ss.app;
    ...
    SmartSelect.prototype.onOpened = function () {
        var ss = this;
    ...
    SmartSelect.prototype.onClose = function () {
        var ss = this;
        if (ss.destroyed)
            return;
        // Destroy VL
    ...
    SmartSelect.prototype.onClosed = function () {
        var ss = this;
        if (ss.destroyed)
            return;
        ss.opened = false;
    ...
    SmartSelect.prototype.renderSearchbar = function () {
        var ss = this;
        if (ss.params.renderSearchbar)
            return ss.params.renderSearchbar();
    ...
    SmartSelect.prototype.renderItem = function (index, item) {
        var ss = this;
        if (ss.params.renderItem)
            return ss.params.renderItem(index, item);
        var itemHtml;
        if (item.isLabel) {
    ...
    SmartSelect.prototype.renderItems = function () {
        var ss = this;
        if (ss.params.renderItems)
            return ss.params.renderItems(ss.items);
        var itemsHtml = "\n      " + ss.items.map(function (item, index) { return "" + ss.renderItem(index, item); }).join('') + "\n    ";
        return itemsHtml;
    };
    SmartSelect.prototype.renderPage = function () {
        var ss = this;
        if (ss.params.renderPage)
            return ss.params.renderPage(ss, ss.items);
    ...
    SmartSelect.prototype.openPage = function () {
        var ss = this;
        if (ss.opened)
            return ss;
        ss.getItemsData();
    ...
    SmartSelect.prototype.renderPopup = function () {
        var ss = this;
        if (ss.params.renderPopup)
            return ss.params.renderPopup(ss, ss.items);
        var pageTitle = ss.params.pageTitle;
        if (typeof pageTitle === 'undefined') {
            pageTitle = ss.$el.find('.item-title').text().trim();
        }
    ...
    SmartSelect.prototype.openPopup = function () {
        var ss = this;
        if (ss.opened)
            return ss;
        ss.getItemsData();
    ...
    SmartSelect.prototype.renderSheet = function () {
        var ss = this;
        if (ss.params.renderSheet)
            return ss.params.renderSheet(ss, ss.items);
    ...
    SmartSelect.prototype.openSheet = function () {
        var ss = this;
        if (ss.opened)
            return ss;
        ss.getItemsData();
    ...
    SmartSelect.prototype.renderPopover = function () {
        var ss = this;
        if (ss.params.renderPopover)
            return ss.params.renderPopover(ss, ss.items);
        var popoverHtml = "\n      <div class=\"popover smart-select-popover\" data-select-name=\"" + ss.name + "\">\n        <div class=\"popover-inner\">\n          <div class=\"list smart-select-list-" + ss.id + " " + (ss.params.virtualList ? ' virtual-list' : '') + (ss.params.formColorTheme ? "theme-" + ss.params.formColorTheme : '') + "\">\n            <ul>" + (!ss.params.virtualList && ss.renderItems(ss.items)) + "</ul>\n          </div>\n        </div>\n      </div>\n    ";
        return popoverHtml;
    };
    SmartSelect.prototype.openPopover = function () {
        var ss = this;
        if (ss.opened)
            return ss;
        ss.getItemsData();
        ...
        var popoverParams = {
            ...
            targetEl: ss.$el,
            on: {
                popoverOpen: function (popover) {
                    ss.onOpen('popover', popover.el);
                },
                popoverOpened: function (popover) {
                    ss.onOpened('popover', popover.el);
                },
                popoverClose: function (popover) {
                    ss.onClose('popover', popover.el);
                },
                popoverClosed: function (popover) {
    ...
    SmartSelect.prototype.open = function (type) {
        var ss = this;
        if (ss.opened)
            return ss;
    ...
    SmartSelect.prototype.destroy = function () {
        var ss = this;
    ...
    create: function () {
        ...
        Utils$1.extend(app, {
            smartSelect: {
                ...
                open: function (smartSelectEl) {
                    var ss = app.smartSelect.get(smartSelectEl);
                    if (ss && ss.open)
                        return ss.open();
                    return undefined;
                },
                close: function (smartSelectEl) {
                    var ss = app.smartSelect.get(smartSelectEl);
                    if (ss && ss.close)
                        return ss.close();
                    return undefined;
                },
                get: function (smartSelectEl) {
                    var $smartSelectEl = dom7$1(smartSelectEl);
                    if (!$smartSelectEl.length)
                        return undefined;
...
var Calendar$1 = (function (_super) {
    ...
    function Calendar(app, params) {
        ...
        var _this = _super.call(this, params, [app]) || this;
        var calendar = _this;
        calendar.params = Utils$1.extend({}, params);
        return calendar;
    }
    return Calendar;
}(Framework7Class));
...
var Picker$1 = (function (_super) {
    __extends(Picker, _super);
    function Picker(app, params) {
        if (params === void 0) { params = {}; }
        var _this = _super.call(this, params) || this;
        var picker = _this;
        picker.params = Utils$1.extend({}, params);
        return picker;
    }
    return Picker;
}(Framework7Class));
...
var PullToRefresh$1 = (function (_super) {
    ...
    function PullToRefresh(app, el) {
        ...
        if ($pageEl.find('.navbar').length > 0 || $pageEl.parents('.view').children('.navbar').length > 0)
            hasNavbar = true;
        ...
        function handleTouchMove(e) {
            ...
            if (!isMoved) {
                ...
                if (dynamicTriggerDistance) {
                    ...
                    if (triggerDistance.indexOf('%') >= 0)
                        triggerDistance = ($el[0].offsetHeight * parseInt(triggerDistance, 10)) / 100;
                }
            ...
            if ((touchesDiff > 0 && scrollTop <= 0) || scrollTop < 0) {
                // iOS 8 fix
                if (Device$1.os === 'ios' && parseInt(Device$1.osVersion.split('.')[0], 10) > 7 && scrollTop === 0 && !wasScrolled)
                    useTranslate = true;
                if (useTranslate) {
                    e.preventDefault();
...
var Lazy = {
    ...
    init: function (pageEl) {
        ...
        if (placeholderSrc !== false) {
            lazyLoadImages.each(function (index, lazyEl) {
                if (dom7$1(lazyEl).attr('data-src') && !dom7$1(lazyEl).attr('src'))
                    dom7$1(lazyEl).attr('src', placeholderSrc);
            });
        }
        // load image
        var imagesSequence = [];
    ...
    loadImage: function (imageEl, callback) {
        var app = this;
...
var DataTable$1 = (function (_super) {
    ...
    DataTable.prototype.setCollapsibleLabels = function () {
        var table = this;
    ...
    DataTable.prototype.checkSelectedHeader = function () {
        var table = this;
...
var Fab = {
    morphOpen: function (fabEl, targetEl) {
        var app = this;
...
var Searchbar$1 = (function (_super) {
    ...
    function Searchbar(app, params) {
        ...
        function onInputChange() {
            ...
            if (((sb.$searchContainer && sb.$searchContainer.length > 0) || sb.params.customSearch) &&
    ...
    Searchbar.prototype.clear = function (e) {
        var sb = this;
    ...
    Searchbar.prototype.setDisableButtonMargin = function () {
        var sb = this;
        if (sb.expandable)
            return;
        var app = sb.app;
    ...
    Searchbar.prototype.enable = function (setFocus) {
        var sb = this;
        if (sb.enabled)
            return sb;
        var app = sb.app;
    ...
    Searchbar.prototype.search = function (query, internal) {
        var sb = this;
        if (sb.previousQuery && query.trim() === sb.previousQuery)
            return sb;
        if (typeof (sb.previousQuery) !== 'undefined' && sb.previousQuery.trim() === '' && query.trim() === '')
            return sb;
        ...
        sb.query = query;
        sb.value = query;
        var $searchContainer = sb.$searchContainer, $el = sb.$el, $backdropEl = sb.$backdropEl, $foundEl = sb.$foundEl, $notFoundEl = sb.$notFoundEl, isVirtualList = sb.isVirtualList;
        // Add active/inactive classes on overlay
        if (query.length === 0) {
            if ($searchContainer && $searchContainer.length && $el.hasClass('searchbar-enabled') && $backdropEl)
                $backdropEl.addClass('searchbar-backdrop-in');
        }
        ...
        if (isVirtualList) {
            ...
            if (sb.params.removeDiacritics)
                values_1 = Utils$1.removeDiacritics(query.trim().toLowerCase()).split(' ');
            else {
                values_1 = query.trim().toLowerCase().split(' ');
            }
            $searchContainer.find(sb.params.searchItem).removeClass('hidden-by-searchbar').each(function (itemIndex, itemEl) {
                ...
                $itemEl.find(sb.params.searchIn).each(function (searchInIndex, searchInEl) {
                    ...
                    if (sb.params.removeDiacritics)
                        itemText = Utils$1.removeDiacritics(itemText);
                    compareWithText.push(itemText);
                });
                compareWithText = compareWithText.join(' ');
                var wordsMatch = 0;
                for (var i = 0; i < values_1.length; i += 1) {
                    if (compareWithText.indexOf(values_1[i]) >= 0)
                        wordsMatch += 1;
                }
                if (wordsMatch !== values_1.length && !(sb.params.ignore && $itemEl.is(sb.params.ignore))) {
    ...
    create: function () {
        ...
        ('clear enable disable toggle search destroy').split(' ').forEach(function (searchbarMethod) {
            searchbar[searchbarMethod] = function (searchbarEl) {
                ...
                if (sb)
                    return sb[searchbarMethod].apply(sb, __spread(args));
                return undefined;
            };
        });
        Utils$1.extend(app, {
...
var Messages$1 = (function (_super) {
    ...
    Messages.prototype.getMessageData = function (messageEl) {
        var m = this;
    ...
    Messages.prototype.getMessagesData = function () {
        var m = this;
        var data = [];
    ...
    Messages.prototype.renderMessage = function (messageToRender) {
        var m = this;
    ...
    Messages.prototype.renderMessages = function (messagesToRender, method) {
    ...
    Messages.prototype.isFirstMessage = function () {
        var args = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            args[_i] = arguments[_i];
        }
        ...
        if (m.params.firstMessageRule)
            return (_a = m.params).firstMessageRule.apply(_a, __spread(args));
        return false;
        var _a;
    };
    Messages.prototype.isLastMessage = function () {
        var args = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            args[_i] = arguments[_i];
        }
        ...
        if (m.params.lastMessageRule)
            return (_a = m.params).lastMessageRule.apply(_a, __spread(args));
        return false;
        var _a;
    };
    Messages.prototype.isTailMessage = function () {
        var args = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            args[_i] = arguments[_i];
        }
        ...
        if (m.params.tailMessageRule)
            return (_a = m.params).tailMessageRule.apply(_a, __spread(args));
        return false;
        var _a;
    };
    Messages.prototype.isSameNameMessage = function () {
        var args = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            args[_i] = arguments[_i];
        }
        ...
        if (m.params.sameNameMessageRule)
            return (_a = m.params).sameNameMessageRule.apply(_a, __spread(args));
        return false;
        var _a;
    };
    Messages.prototype.isSameHeaderMessage = function () {
        var args = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            args[_i] = arguments[_i];
        }
        ...
        if (m.params.sameHeaderMessageRule)
            return (_a = m.params).sameHeaderMessageRule.apply(_a, __spread(args));
        return false;
        var _a;
    };
    Messages.prototype.isSameFooterMessage = function () {
        var args = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            args[_i] = arguments[_i];
        }
        ...
        if (m.params.sameFooterMessageRule)
            return (_a = m.params).sameFooterMessageRule.apply(_a, __spread(args));
        return false;
        var _a;
    };
    Messages.prototype.isSameAvatarMessage = function () {
        var args = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            args[_i] = arguments[_i];
        }
        ...
        if (m.params.sameAvatarMessageRule)
            return (_a = m.params).sameAvatarMessageRule.apply(_a, __spread(args));
        return false;
        var _a;
    };
    Messages.prototype.isCustomClassMessage = function () {
        var args = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            args[_i] = arguments[_i];
        }
        ...
        if (m.params.customClassMessageRule)
            return (_a = m.params).customClassMessageRule.apply(_a, __spread(args));
        return undefined;
        var _a;
    };
    ...
    Messages.prototype.removeMessage = function (messageToRemove, layout) {
    ...
    Messages.prototype.removeMessages = function (messagesToRemove, layout) {
        if (layout === void 0) { layout = true; }
        var m = this;
        if (Array.isArray(messagesToRemove)) {
            var messagesToRemoveEls_1 = [];
            messagesToRemove.forEach(function (messageToRemoveIndex) {
                messagesToRemoveEls_1.push(m.$el.find('.message, .messages-title').eq(messageToRemoveIndex));
            });
            messagesToRemoveEls_1.forEach(function (messageToRemove) {
    ...
    Messages.prototype.addMessage = function () {
        ...
        var method;
        if (typeof args[1] === 'boolean') {
            _a = __read(args, 3), messageToAdd = _a[0], animate = _a[1], method = _a[2];
        }
        else {
            _b = __read(args, 3), messageToAdd = _b[0], method = _b[1], animate = _b[2];
        }
        if (typeof animate === 'undefined') {
            animate = true;
        }
    ...
    Messages.prototype.addMessages = function () {
        var args = [];
        for (var _i = 0; _i < arguments.length; _i++) {
            args[_i] = arguments[_i];
        }
        ...
        var method;
        if (typeof args[1] === 'boolean') {
            _a = __read(args, 3), messagesToAdd = _a[0], animate = _a[1], method = _a[2];
        }
        else {
            _b = __read(args, 3), messagesToAdd = _b[0], method = _b[1], animate = _b[2];
        }
        if (typeof animate === 'undefined') {
            animate = true;
        }
    ...
    Messages.prototype.showTyping = function (message) {
    ...
    Messages.prototype.hideTyping = function () {
        var m = this;
    ...
    Messages.prototype.scroll = function (duration, scrollTop) {
    ...
    create: function () {
        ...
        ('renderMessages layout scroll clear removeMessage removeMessages addMessage addMessages destroy').split(' ').forEach(function (messagesMethod) {
            messages[messagesMethod] = function (messagesEl) {
                ...
                if (m)
                    return m[messagesMethod].apply(m, __spread(args));
                return undefined;
            };
        });
        Utils$1.extend(app, {
...
var Messagebar$1 = (function (_super) {
    ...
    Messagebar.prototype.focus = function () {
        var messagebar = this;
        messagebar.$textareaEl.focus();
        return messagebar;
    };
    Messagebar.prototype.blur = function () {
        var messagebar = this;
        messagebar.$textareaEl.blur();
        return messagebar;
    };
    Messagebar.prototype.clear = function () {
        var messagebar = this;
        messagebar.$textareaEl.val('').trigger('change');
        return messagebar;
    };
    Messagebar.prototype.getValue = function () {
        var messagebar = this;
        return messagebar.$textareaEl.val().trim();
    };
    Messagebar.prototype.setValue = function (value) {
        var messagebar = this;
        messagebar.$textareaEl.val(value).trigger('change');
        return messagebar;
    };
    Messagebar.prototype.setPlaceholder = function (placeholder) {
        var messagebar = this;
        messagebar.$textareaEl.attr('placeholder', placeholder);
        return messagebar;
    };
    Messagebar.prototype.resize = function () {
        var messagebar = this;
    ...
    Messagebar.prototype.checkEmptyState = function () {
        var messagebar = this;
    ...
    Messagebar.prototype.attachmentsCreate = function (innerHTML) {
    ...
    Messagebar.prototype.attachmentsShow = function (innerHTML) {
        if (innerHTML === void 0) { innerHTML = ''; }
        var messagebar = this;
    ...
    Messagebar.prototype.attachmentsHide = function () {
        var messagebar = this;
    ...
    Messagebar.prototype.attachmentsToggle = function () {
        var messagebar = this;
    ...
    Messagebar.prototype.renderAttachment = function (attachment) {
        var messagebar = this;
    ...
    Messagebar.prototype.renderAttachments = function () {
        var messagebar = this;
        var html;
    ...
    Messagebar.prototype.sheetCreate = function (innerHTML) {
        if (innerHTML === void 0) { innerHTML = ''; }
        var messagebar = this;
    ...
    Messagebar.prototype.sheetShow = function (innerHTML) {
        if (innerHTML === void 0) { innerHTML = ''; }
        var messagebar = this;
    ...
    Messagebar.prototype.sheetHide = function () {
        var messagebar = this;
    ...
    Messagebar.prototype.sheetToggle = function () {
        var messagebar = this;
    ...
    create: function () {
        ...
        ('clear getValue setValue setPlaceholder resize focus blur attachmentsCreate attachmentsShow attachmentsHide attachmentsToggle renderAttachments sheetCreate sheetShow sheetHide sheetToggle destroy').split(' ').forEach(function (messagebarMethod) {
            messagebar[messagebarMethod] = function (messagebarEl) {
                ...
                if (mb)
                    return mb[messagebarMethod].apply(mb, __spread(args));
                return undefined;
            };
        });
        Utils$1.extend(app, {
